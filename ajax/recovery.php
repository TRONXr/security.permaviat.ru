...
if ($user = $query_user->fetch_assoc()) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'elton2012alex@yandex.ru'; 
        $mail->Password = 'ikdsventawvhykuo'; 
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port = 465;

        $mail->CharSet = 'UTF-8';
        $mail->setFrom('elton2012alex@yandex.ru', 'Умудов Эльтон');
        ...
        $mail->Body = "
            ...
            <p>Для входа в систему перейдите по ссылке: <a href='http://localhost/10пр/security/login.php'>Войти в систему</a>.</p>
